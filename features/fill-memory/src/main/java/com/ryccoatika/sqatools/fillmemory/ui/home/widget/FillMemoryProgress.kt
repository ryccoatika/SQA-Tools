...
@Composable
internal fun FillMemoryProgress(
  ...
  Dialog(
    ...
    Surface(
      ...
      Column(
        ...
        16.VerticalSpace()
        Text(
          text = textCreator.fillMemoryProgress(progress),
        )
        8.VerticalSpace()
        ...
        Button(
          ...
          Text(textCreator.fillMemoryProgressButtonText(progress))
        }
      }
    }
  }
...
@PreviewLightDark
@Composable
private fun FillMemoryProgressPreview() {
